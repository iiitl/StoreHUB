      ...
      <nav className="fixed top-0 left-0 right-0 bg-white border-b border-black/10 z-50">
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <NavLink to="/trending" className={getLinkClasses()}>
              <NavItem icon={<Flame />} label="Trending" />
            </NavLink>
            <NavLink to="/sandbox" className={getLinkClasses()}>
              <NavItem icon={<Book />} label="Sandbox" />
            </NavLink>
            <NavLink to="/discussion" className={getLinkClasses()}>
              <NavItem icon={<Users />} label="Discussion" />
            </NavLink>
          </div>

          <div className="hidden lg:flex items-center space-x-4">
            <NavLink to="/create" className={getLinkClasses()}>
        ...
        {isMenuOpen && (
          <div className="lg:hidden flex flex-col bg-white border-t border-black/10">
            <NavLink
              to="/"
              className={getLinkClasses("p-4 hover:bg-gray-100")}
            ...
            <NavLink
              to="/create"
              className={getLinkClasses("p-4 hover:bg-gray-100 md:border md:border-1 md:border-black/10")}
              onClick={() => setIsMenuOpen(false)}
            >
              Create
            </NavLink>
            <NavLink
              to="/profile"
              className={getLinkClasses("p-4 hover:bg-gray-100 flex items-center space-x-2")}
              onClick={() => setIsMenuOpen(false)}
            >
